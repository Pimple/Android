...
public class EarthquakeProvider extends ContentProvider {
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		...
		case QUAKE_ID:
			...
			count = database.delete(EarthquakeDatabaseHelper.EARTHQUAKE_TABLE, KEY_ID + "=" + segment
	...
	private static class EarthquakeDatabaseHelper extends SQLiteOpenHelper {
		...
		private static final String DATABASE_CREATE = "create table " + EARTHQUAKE_TABLE + " (" + KEY_ID
				+ " integer primary key autoincrement, " + KEY_DATE + " INTEGER, " + KEY_DETAILS
				+ " TEXT, " + KEY_SUMMARY + " TEXT, " + KEY_LOCATION_LAT + " FLOAT, " + KEY_LOCATION_LNG
