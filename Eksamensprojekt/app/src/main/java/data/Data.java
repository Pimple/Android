...
public class Data extends SQLiteOpenHelper
{
	...
	public static final String[] ALL_COLUMNS = {KOERSEL_ID, KOERSEL_ADRESSE_FRA, KOERSEL_ADRESSE_TIL, KOERSEL_REG_NR, KOERSEL_DATO_FRA, KOERSEL_DATO_TIL, KOERSEL_KM_FRA,
			KOERSEL_KM_TIL, KOERSEL_KM_I_ALT, KOERSEL_FORMAAL};

	public static final String KOERSLER_TABELNAVN = "koersler";

	private static final String OPRET_KOERSLER =
			"create table if not exists " + KOERSLER_TABELNAVN +
			"(" +
					KOERSEL_ID + " integer primary key autoincrement, " +
					KOERSEL_ADRESSE_FRA + " text not null, " +
					KOERSEL_ADRESSE_TIL + " text not null, " +
	...
	{
		Log.w(Data.class.getName(), "Opgraderede databasen fra version " + oldVersion + " til " + newVersion +
				". " +
				"Held og lykke.");
